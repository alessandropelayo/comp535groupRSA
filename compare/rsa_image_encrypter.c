...
int main(int argc, char *argv[]) {
    ...
    // Gets the average of n runs
    const int numTrials = 100;
    double totalParallelTime = 0.0;
    double totalSequentialTime = 0.0;
    ...
    double avgParallelTime = totalParallelTime / numTrials;
    double avgSequentialTime = totalSequentialTime / numTrials;

    printf("Number of runs: %d\n", numTrials);

    printf("Parallel encryption time avg: %f seconds\n", avgParallelTime);

    printf("Sequential encryption time avg: %f seconds\n", avgSequentialTime);
